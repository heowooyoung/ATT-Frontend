...
// import {PutObjectCommand, ListObjectsCommand, DeleteObjectCommand,
//     GetObjectCommand, PutObjectAclCommand, ObjectCannedACL} from '@aws-sdk/client-s3';
...
//             const params = {
//                 Bucket: 'att-bucket',
//                 Key: this.selectedFile!.name, // 파일이름
...
//                 this.uploadedFileURL = `http://${params.Bucket}.s3.${env.s3.AWS_REGION}.amazonaws.com/${params.Key}`;
...
//             const params = {
//                 Bucket: 'att-bucket',
//                 Key: key // db에 파일을 넣어 CRUD를 수행 가능 (근데, 이름 중복될 수 있으므로 중복 구분을 해줘야..)
//             };
